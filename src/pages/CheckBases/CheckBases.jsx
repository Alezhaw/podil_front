...
function CheckBases() {
  ...
  useEffect(() => {
    const savedFilterColumns = JSON.parse(localStorage.getItem(`filterColumnsCheckBase ${selectedLang}`) || "[]");
              ...
              {filterColumns.map((el, index) => (
                <MenuItem
                  ...
                  onClick={(e) => {
                    ...
                    localStorage.setItem(`filterColumnsCheckBase ${selectedLang}`, JSON.stringify(updatedFilterColumns));
                  }}
                >
            ...
            <table>
              <thead className="tableHeader">
                <tr className="tableHeader">
                  ...
                  <th style={{ minWidth: "70.8px", border: "1px solid black" }}>ID</th>
