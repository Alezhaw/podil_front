...
function TrailTableID({ country, messages, trail, setTrail, getFormsByCityAndName, getValueById, createCity }) {
  ...
  return (
    <ContainerForTable style={{ padding: "0px", margin: "0px" }}>
      <table style={{ textAlign: "center" }}>
        ...
        <tbody>
          <tr style={{ textAlign: "center" }}>
              ...
              <div className="tableInput">
                <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }}>
                  <Select
                    ...
                    value={trail.presentation_time_id || ""}
                    onChange={(e) => {
                      setTrail((prev) => ({ ...prev, presentation_time_id: e.target.value }));
                    }}
            ...
            <td className="basesTableCell" style={{ maxWidth: "unset" }}>
              {/* <TrailSelect forRegions valueKey="regionId" trail={trail} setTrail={setTrail} array={allDictionary?.regions} arrayKey="region" /> */}
              <Autocomplete
                disablePortal
                id="combo-box-demo"
                disableClearable
            ...
            <td className="basesTableCell" style={{ maxWidth: "unset" }}>
              {/* <TrailSelect valueKey="city_id" trail={trail} setTrail={setTrail} array={allCitiesWithRegions} arrayKey="city_name" /> */}
              <Autocomplete
                disablePortal
